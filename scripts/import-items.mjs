    ...
    try {
      ...
      for (const item of items) {
        ...
        allRows.push({
          ...
          size:         typeof item.size === "object" ? null : (item.size ?? null),
          grade:        typeof item.grade === "object" ? null : (item.grade != null ? String(item.grade) : null),
          image_url:    null,
    ...
    try {
      ...
      for (const v of vehicles) {
        ...
        allRows.push({
          ...
          size:         null,
          grade:        null,
          crew:         typeof v.crew === "object" ? (v.crew?.max ?? v.crew?.min ?? null) : (v.crew ?? null),
          cargo:        typeof v.cargo_capacity === "object" ? null : (v.cargo_capacity != null ? Math.round(Number(v.cargo_capacity)) : null),
          msrp:         typeof v.msrp === "object" ? null : (v.msrp != null ? Math.round(Number(v.msrp)) : null),
